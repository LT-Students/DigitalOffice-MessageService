namespace LT.DigitalOffice.MessageService.Mappers.Interfaces
{
    /// <summary>
    /// Represents interface for a mapper in mapper pattern.
    /// Provides methods for converting an object of <see cref="TIn"/>
    /// type into an object of <see cref="TOut"/> type according to some rule.
    /// </summary>
    ...
    /// <summary>
    /// Represents mapper. Provides methods for converting objects of
    /// <see cref="TIn1"/> and <see cref="TIn2"/> types into an object of <see cref="TOut"/> type according to some rule.
    /// </summary>
    ...
    {
        /// <summary>
        /// Convert objects of <see cref="TIn1"/> and <see cref="TIn2"/>
        /// types into an object of <see cref="TOut"/> type according to some rule.
        /// </summary>
