...
{
  public class CreateWorkspaceUserValidator : AbstractValidator<List<Guid>>, ICreateWorkspaceUserValidator
  {
    private readonly IRequestClient<ICheckUsersExistence> _rcCheckUsersExistence;
    private readonly ILogger<CreateWorkspaceUserValidator> _logger;

    public CreateWorkspaceUserValidator(
      IRequestClient<ICheckUsersExistence> rcCheckUsersExistence,
      ILogger<CreateWorkspaceUserValidator> logger)
    {
      ...
      RuleForEach(users => users)
        ...
        .ChildRules(users =>
          RuleFor(users => users)
            ...
            .WithMessage("User cannot be added to the workspace twice.")
